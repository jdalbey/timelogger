...
/**
 * A simple FontChooser dialog that implements similar functionality to the
 * JFileChooser, JOptionPane and JColorChooser components provided with
 * Swing.<p>
 * Upon initialization, the JFontChooser polls the system for all available
 * fonts, initializes the various JList components to the values of the default
 * font and provides a preview of the font. As options are changed/selected the
 * preview is updated to display the current font.<p>
 * JFileChooser can either be created and added to a GUI as a typical JComponent
 * or it can display a JDialog using the
 * {@link #showDialog(Component, String) showDialog} method (just like the
 * <b>JFileChooser</b> component). Objects that extend JFontChooser should use
 * the {@link #acceptSelection() acceptSelection} and
 * {@link #cancelSelection() cancelSelection} methods to determine either an
 * accept or cancel selection.<p>
 * <i>Example:</i>
 * <blockquote>
 * <samp>
 * JFontChooser chooser = new JFontChooser(new Font("Arial", Font.BOLD,
 * 12));<br>
 * if (chooser.showDialog(this, "Choose a font...") ==
 * JFontChooser.ACCEPT_OPTION) {<br>
 * &nbsp;&nbsp;Font f = chooser.getSelectedFont();<br>
 * &nbsp;&nbsp;// Process font here...<br>
 * }<br>
 * </samp></blockquote>
 * <p>
 */
public class JFontChooser extends JComponent implements ActionListener, ListSelectionListener
{
    ...
    /**
     * Constructs a new JFontChooser component initialized to the supplied font
     * object.
     *
     * @see	com.lamatek.swingextras.JFontChooser#showDialog(Component, String)
     */
    ...
    /**
     * Returns the currently selected font. Typically called after receipt of an
     * ACCEPT_OPTION (using the
     * {@link #showDialog(Component, String) showDialog} option) or from within
     * the approveSelection method (using the component option).
     *
     * @return java.awt.Font A font class that represents the currently selected
     * font.
     */
     ...
     * the currently displayed font. Children of JFontChooser should override
     * this method to process this event.
     */
    ...
    /**
     * This method is called when the user presses the cancel button. Children
     * of JFontChooser should override this method to process this event.
     */
